    ...
    <form @submit.prevent="handleSubmit" class="station-form">
      ...
      <div class="form-group">
        ...
        <small class="form-help">
          Find this on your Ecowitt device or in the WS View app
        </small>
      </div>
      ...
      <div class="form-group">
        ...
        />
        <small class="form-help">
          Get this from your Ecowitt account dashboard
        </small>
      </div>
...
import type { AddStationForm } from '../types/weather';
...
async function handleSubmit() {
  ...
  try {
    ...
    error.value = err instanceof Error ? err.message : 'Failed to add station';
  } finally {
    loading.value = false;
  }
}
